...
const memoryLogger = new WebhookClient({ url: 'https://discord.com/api/webhooks/1205476563055943742/Pompatb-X1IYuU6ERKdfT6-YVx5vXyEGAj_mrlu9LpFEqYL0EwmCWRDFezLg_PKBRJvY' })
...
module.exports = class MemorySweeper {
  ...
  run() {
    ...
    for (const guild of this.client.guilds.cache.values()) {
      ...
      // Clear emojis
      if (guild.id !== "1199415064478887956") { // don't clear support guild's emojis.
    ...
    if (this.client.user.tag !== "king5929#0000") return;
